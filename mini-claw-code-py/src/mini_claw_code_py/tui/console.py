...
DEFAULT_COMMAND_ROWS: Final[tuple[tuple[str, str], ...]] = (
    ...
    ("/agent add <name> --workspace <path> --description \"...\"", "add a hosted agent to the project registry"),
    ("/channels", "show discovered channel definitions"),
    ("/channel add <name> (--agent <name> | --team <name>) ...", "add a channel to the project registry"),
    ("/teams", "show discovered teams"),
    ("/team add <name> --lead <agent> ...", "add a team to the project registry"),
    ...
    ("/mcp add <stdio|http|sse> <name> ...", "add an MCP server to the project config"),
    ...
    ("/use <agent|team|channel> <name>", "switch the active front-door route"),
