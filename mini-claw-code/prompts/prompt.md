...
- If you notice unexpected changes that conflict with your work, stop and ask the user how to proceed.
...
- For frontend work, avoid generic layouts, preserve existing design systems, and ensure the result works on desktop and mobile.
